...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlayerList.addPlayer(new Player("Tom"));
        PlayerList.addPlayer(new Player("Liza"));
        ...
        btnStartGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(PlayerList.getPlayerList().size()<2){
                    Toast.makeText(getApplicationContext(), "A minimum of 2 players is required", Toast.LENGTH_SHORT).show();
                }else{
